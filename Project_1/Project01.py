...
def OrganizeVideo():
    ...
    ffmpeg.input('video_rear.txt', format='concat', safe=0).output('output.mkv', c='copy').run()
    ffmpeg.input('video_front.txt', format='concat', safe=0).output('output.mkv', c='copy').run()
